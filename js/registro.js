...
form.addEventListener('submit', (event) => {
    ...
    const mensaje = username+" Consulta disponibilidad para la fecha: " + fecha+ ", "  +" En horario de: "+ hora;
     ...
     const mensajeWhatsApp = {
        numero: "50255582363", // Número de teléfono con código de país
        texto: "Hola, mi nombre es: "+username+" consulto disponibilidad para la fecha: " + fecha+ ", "  +" en horario de: "+ hora + " para el servicio de: " +servicio
      };
